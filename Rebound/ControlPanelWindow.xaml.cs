    ...
    public void NavigateToPath(bool legacyHomePage = false)
    {
        ...
        switch (AddressBox.Text)
        {
            case @"Control Panel\Appearance and Personalization":
                {
                    if (RootFrame.Content is not Rebound.Pages.ControlPanel.AppearanceAndPersonalization) App.cpanelWin.RootFrame.Navigate(typeof(AppearanceAndPersonalization), null, new Microsoft.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo());
                    AppearanceAndPersonalization.Visibility = Visibility.Visible;
                    return;
                }
            case @"Control Panel\System and Security":
                {
                    if (RootFrame.Content is not Rebound.Pages.ControlPanel.SystemAndSecurity) App.cpanelWin.RootFrame.Navigate(typeof(SystemAndSecurity), null, new Microsoft.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo());
                    SystemAndSecurity.Visibility = Visibility.Visible;
                    return;
                }
            case @"Control Panel\System and Security\Windows Tools":
                {
                    if (RootFrame.Content is not Rebound.Pages.ControlPanel.WindowsTools) App.cpanelWin.RootFrame.Navigate(typeof(WindowsTools), null, new Microsoft.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo());
                    SystemAndSecurity.Visibility = Visibility.Visible;
