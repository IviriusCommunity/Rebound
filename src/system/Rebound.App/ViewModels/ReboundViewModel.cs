...
internal partial class ReboundViewModel : ObservableObject
{
    ...
    private async void LoadSettings()
    {
        ...
        InstallThisAppCantRunOnYourPC = SettingsHelper.GetValue("InstallThisAppCantRunOnYourPC", "rebound", true);
        InstallAppwiz = SettingsHelper.GetValue("InstallAppwiz", "rebound", true);
    ...
    partial void OnInstallShutdownDialogChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("InstallShutdownDialog", "rebound", newValue);
    partial void OnInstallShortcutsChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("InstallShortcuts", "rebound", newValue);
    partial void OnInstallThisAppCantRunOnYourPCChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("InstallThisAppCantRunOnYourPC", "rebound", newValue);
    partial void OnInstallAppwizChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("InstallAppwiz", "rebound", newValue);
    partial void OnInstallWindowsToolsChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("InstallWindowsTools", "rebound", newValue);
    partial void OnEnableAutomaticRepairChanged(bool oldValue, bool newValue) => SettingsHelper.SetValue("EnableAutomaticRepair", "rebound", newValue);
