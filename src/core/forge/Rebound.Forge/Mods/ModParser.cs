...
#pragma warning restore CA1002 // Do not expose generic lists
    {
        ...
        try
        {
            ...
            {
                ReboundLogger.Log($"[ModLoader] Mods folder does not exist: {Variables.ReboundModsFolder}");
                return mods; // return empty list
            }

            ReboundLogger.Log($"[ModLoader] Parsing mods in folder: {Variables.ReboundModsFolder}");
