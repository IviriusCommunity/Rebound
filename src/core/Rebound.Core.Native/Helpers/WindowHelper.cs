...
public static class WindowHelper
{
    public static unsafe void Activate(HWND handle)
    {
        ...
        {
            TerraFX.Interop.Windows.Windows.ShowWindow(handle, SW.SW_RESTORE); // restore window
        }
        TerraFX.Interop.Windows.Windows.SetForegroundWindow(handle); // bring to front
    }
