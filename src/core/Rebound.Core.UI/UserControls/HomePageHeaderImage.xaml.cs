...
namespace WinUIGallery.Controls
{
    ...
    DependencyProperty.Register("ImageHorizontalAlignment", typeof(HorizontalAlignment), typeof(HomePageHeaderImage), new PropertyMetadata(HorizontalAlignment.Left));
        ...
        public static readonly DependencyProperty HorizontalAlignmentRatioProperty =
            DependencyProperty.Register("HorizontalAlignmentRatio", typeof(double), typeof(HomePageHeaderImage), new PropertyMetadata((double)0));
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            _imageGridSurfaceBrush.HorizontalAlignmentRatio = (float)HorizontalAlignmentRatio;
        ...
        public double HorizontalAlignmentRatio
        {
            get
            {
                return (double)GetValue(HorizontalAlignmentRatioProperty);
            }
            set
            {
                SetValue(HorizontalAlignmentRatioProperty, value);
                OnPropertyChanged();
                if (_imageGridSurfaceBrush != null)
                    _imageGridSurfaceBrush.HorizontalAlignmentRatio = (float)value;
            }
        }
