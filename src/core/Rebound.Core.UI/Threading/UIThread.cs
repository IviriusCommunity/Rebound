...
using static TerraFX.Interop.Windows.Windows; // ADD THIS

namespace Rebound.Core.UI.Threading;
...
public static class UIThread
{
    ...
    // ADD THIS METHOD:
    public static void SetMainThreadId(uint threadId)
    {
    ...
    public static void QueueAction(Func<Task> action)
    {
        ...
        // ADD THIS LINE:
        if (_mainThreadId != 0) PostThreadMessageW(_mainThreadId, WM_NULL, 0, 0);
    }
